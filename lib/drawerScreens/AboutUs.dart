      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              "Hello, welcome to Tellmeastorymom. I'm Sweta, founder of Tellmeastorymom. Currently, I am living in Singapore with my Husband and a cute little daughter."
              "I am an IT professional and currently working in Singapore. My roots are from a small city in Madhya Pradesh (India). Tellmeastorymom is my passion. I started it as my hobby in December 2016, but now it’s like my second child."
              "My daughter is the inspiration behind this whole idea. Because of her, I realized that stories play an important role in the overall development of a child. If you have good and meaningful story for a certain topic, then your child will learn that topic very easily. But to have stories on your fingertips is also very difficult, because we have lots of other things in our mind, so it’s really difficult to recall all the stories when your little one want you to narrate."
            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: "Email-ID: hgurhgewhgh@kjrnbrj.in\n",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 14 * ScreenSize.heightMultiplyingFactor,
                      fontFamily: 'Poppins-Regular',
                  ...
                  TextSpan(
                    text: "Phone-Number/Fax-Number: 6548609480\n",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 14 * ScreenSize.heightMultiplyingFactor,
                      fontFamily: 'Poppins-Regular',
